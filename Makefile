...
SHELL := /bin/bash
# Charm variables
CHARM_NAME := patchman-server
CHARM_STORE_URL := cs:~huntdatacenter/patchman-server
CHARM_HOMEPAGE := https://github.com/huntdatacenter/charm-patchman-server/
CHARM_BUGS_URL := https://github.com/huntdatacenter/charm-patchman-server/issues
